-- =============================================
-- FULL DATABASE SCHEMA FOR THE SHIPPING SYSTEM
-- =============================================
...
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS courier_assigned_at TIMESTAMP WITH TIME ZONE;
...
-- ===== Scan sessions, items, status history =====
...
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS rejection_commission numeric DEFAULT 0;
